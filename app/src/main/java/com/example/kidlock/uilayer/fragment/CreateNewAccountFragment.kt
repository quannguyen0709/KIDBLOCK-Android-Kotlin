...
class CreateNewAccountFragment : Fragment() {
    ...
    override fun onCreateView(
       ...
       view = inflater.inflate(R.layout.fragment_create_new_account, container, false).apply {
            findViewById<ComposeView>(R.id.composeview_new_create_account).setContent {
                KidlockTheme {
                    Column(
                        modifier = Modifier
                            .fillMaxSize()
