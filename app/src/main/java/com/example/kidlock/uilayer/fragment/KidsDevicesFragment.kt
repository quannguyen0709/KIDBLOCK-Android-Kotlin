...
@AndroidEntryPoint
class KidsDevicesFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        view = inflater.inflate(R.layout.fragment_kids_devices, container, false).apply {
            findViewById<ComposeView>(R.id.composeview_kids_devices).setContent {
                KidlockTheme {
                    Column(
                        modifier = Modifier
                            .fillMaxSize()
